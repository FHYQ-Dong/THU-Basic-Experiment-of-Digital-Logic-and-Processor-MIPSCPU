...
\lstinputlisting[language={[mips]Assembler}, caption={user/sim/sparse\_matmul\_mars.asm}, label={code:sim-sparse-matmul-mars-asm}]{../user/sim/sparse_matmul_mars.asm}
